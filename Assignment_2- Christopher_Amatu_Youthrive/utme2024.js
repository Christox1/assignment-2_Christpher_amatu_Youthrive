...
//Assignment 3
const studentNamesAndScores = utme2024Students.map(student => ({
    firstName: student.firstName,
    score: student.score
}));
console.log(studentNamesAndScores);

//Assignment 4
const totalScore = utme2024Students.reduce((acc, student) => acc + student.score, 0);
